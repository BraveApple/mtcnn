...
data_root = '/home/wang/disk_4T/wang_data/original_dataset/LFWA';
anno_root = fullfile(data_root, 'Anno');
input_root = fullfile(data_root, 'Img');
...
input_label_txt = fullfile(anno_root, 'attr_40_list_tmp.txt');
output_label_txt = fullfile(anno_root, 'output_label.txt');
no_face_txt = fullfile(anno_root, 'no_face.txt');
...
for i = 1:length(img_list)
  ...
  if max_score < 0.9
    ...
    fprintf(no_face_id, '%s --> max_score < 0.9\n', image_name);
    continue;
  end
